...
@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalGt:
    value: decimal.Decimal = dataclasses.field(metadata=mr.decimal_meta(gt=decimal.Decimal("0")))


@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalGte:
    value: decimal.Decimal = dataclasses.field(metadata=mr.decimal_meta(gte=decimal.Decimal("0")))


@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalLt:
    value: decimal.Decimal = dataclasses.field(metadata=mr.decimal_meta(lt=decimal.Decimal("100")))


@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalLte:
    value: decimal.Decimal = dataclasses.field(metadata=mr.decimal_meta(lte=decimal.Decimal("100")))


@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalRange:
    value: decimal.Decimal = dataclasses.field(
        metadata=mr.decimal_meta(gte=decimal.Decimal("0"), lte=decimal.Decimal("100"))
    )


@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalGtCustomError:
    value: decimal.Decimal = dataclasses.field(
        metadata=mr.decimal_meta(gt=decimal.Decimal("0"), gt_error="Custom gt error")
    )


@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalGteCustomError:
    value: decimal.Decimal = dataclasses.field(
        metadata=mr.decimal_meta(gte=decimal.Decimal("0"), gte_error="Custom gte error")
    )


@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalLtCustomError:
    value: decimal.Decimal = dataclasses.field(
        metadata=mr.decimal_meta(lt=decimal.Decimal("100"), lt_error="Custom lt error")
    )


@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalLteCustomError:
    value: decimal.Decimal = dataclasses.field(
        metadata=mr.decimal_meta(lte=decimal.Decimal("100"), lte_error="Custom lte error")
    )


@dataclasses.dataclass(frozen=True, slots=True, kw_only=True)
class WithDecimalRangeAndPlaces:
    value: decimal.Decimal = dataclasses.field(
        metadata=mr.decimal_meta(gte=decimal.Decimal("0"), lte=decimal.Decimal("100"), places=2)
    )
