...
Models mirror the real anna-balance TransactionData hierarchy for Faster Payment (FP)
transactions — a deep, wide object tree with nested dataclasses, enums, UUIDs,
datetimes, decimals, and optional fields.
"""
import dataclasses
import datetime
import decimal
