...
def str_field(
    *,
    ...
    error_messages: collections.abc.Mapping[str, str] | None = None,
    **_: Any,
) -> m.fields.Field:
    if default is m.missing:
        return StrField(
            ...
            **error_messages_fields(error_messages),
        )
...
def error_messages_fields(
    error_messages: collections.abc.Mapping[str, str] | None,
