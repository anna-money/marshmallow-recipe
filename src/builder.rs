...
pub enum NoneValueHandling {
    Ignore,
    Include,
}

impl NoneValueHandling {
...
impl ContainerBuilder {
    #[new]
    #[pyo3(signature = (*, none_value_handling="ignore", decimal_places=None))]
    fn new(none_value_handling: &str, decimal_places: Option<i32>) -> Self {
        Self {
            fields: Vec::new(),
            dataclasses: Vec::new(),
            types: Vec::new(),
            none_value_handling: NoneValueHandling::from_str(none_value_handling),
    ...
    fn str_field(
        ...
        let container = FieldContainer::Str { common, strip_whitespaces };
    ...
    #[pyo3(signature = (cls, fields, *, can_use_direct_slots=false, has_post_init=false))]
    fn dataclass(
        &mut self,
        py: Python<'_>,
        cls: Py<PyAny>,
        ...
        let ignore_none = self.none_value_handling == NoneValueHandling::Ignore;
        ...
        for handle in fields {
            ...
            let dc_field = DataclassField {
                ...
                post_load: builder_field.post_load.as_ref().map(|v| v.clone_ref(py)),
