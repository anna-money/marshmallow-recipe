...
#[pyfunction]
#[pyo3(signature = (schema_id, json_bytes, post_loads=None, encoding="utf-8"))]
pub fn load_from_bytes(
    ...
    crate::deserialize_bytes::load_from_bytes(py, &utf8_bytes, descriptor, post_loads)
}
...
#[pyfunction]
#[pyo3(signature = (schema_id, data, post_loads=None))]
pub fn load(
    py: Python,
    schema_id: u64,
    data: &Bound<'_, PyAny>,
